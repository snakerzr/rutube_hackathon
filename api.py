...
from rag_proto import rag_pipeline
...
tokenizer = AutoTokenizer.from_pretrained('clf_one_opt/')

clf_one = ORTModelForSequenceClassification.from_pretrained('clf_one_opt')
clf_two = ORTModelForSequenceClassification.from_pretrained('clf_two_opt')
...
with open('if2label_one.json', 'r') as json_file:
    id2label_one = json.load(json_file)

with open('id2label_two.json', 'r') as json_file:
